...
//    private Notification mCurrentNotification;
    ...
    private Notification.Builder getCurrentNotificationBuilder(){
        if(mCurrentNotificationBuilder == null){
            mCurrentNotificationBuilder = new Notification.Builder(mContext);
        }
        return mCurrentNotificationBuilder;
    }
    ...
    public void onDownloadStateChanged(int newState) {
        ...
        if (newState != mState) {
            ...
            getCurrentNotificationBuilder().setAutoCancel(false)
...
//            }
            mNotificationManager.notify(NOTIFICATION_ID, getCurrentNotificationBuilder().build());
        }
    }
    ...
    public void onDownloadProgress(DownloadProgressInfo progress) {
        ...
        if (progress.mOverallTotal <= 0) {
            ...
            getNotificationBuilder().setTicker(mCurrentTitle)
