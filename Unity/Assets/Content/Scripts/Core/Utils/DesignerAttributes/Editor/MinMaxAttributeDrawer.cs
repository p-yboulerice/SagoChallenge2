namespace Juice.Utils {
	...
	public class MinMaxAttributeDrawer : PropertyDrawer {
		...
		private void DrawFloatMinMaxField(Rect rect, SerializedProperty property, GUIContent label) {
			...
			if (Event.current.isKey && Event.current.keyCode == KeyCode.Return && GUI.GetNameOfFocusedControl() == MinEdit) {
			...
			if (Event.current.isKey && Event.current.keyCode == KeyCode.Return && GUI.GetNameOfFocusedControl() == MaxEdit) {
